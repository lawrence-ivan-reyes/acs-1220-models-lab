...
class Book(db.Model):
    ...
    def __repr__(self):
        return f'<Book: {self.title}, Author: {self.author.name if self.author else "Unknown"}, Audience: {self.audience.name}>'
...
# for the mtm relationship bw User & Book
...
class User(db.Model):
    ...
    # mtm relationship w Book
    favorite_books = db.relationship('Book', secondary='favorite_book', backref='users_who_favorited')
